...
//      plugin("kotlin-compose-compiler-plugin", "org.jetbrains.kotlin.plugin.compose").versionRef("kotlin")
//    }
//
//    create("libs") {
...
//      version("androidx-media3", "1.3.1") // 1.4.1
//      version("androidx-navigation", "2.8.0")
//      version("androidx-window", "1.3.0")
//      version("exoplayer", "2.19.1")
//      version("glide", "4.16.0")
//      version("kotlin", "2.0.21")
//      version("libsignal-client", "0.58.2") // 0.59.0
//      version("mp4parser", "1.9.56")
//      version("android-gradle-plugin", "8.6.1")
