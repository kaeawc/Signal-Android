 ...
 */
class SafetyNumberReviewConnectionsFragment :
  DSLSettingsFragment(
  ...
  private fun getActionItemsForBucket(bucket: SafetyNumberBucket): List<ActionItem> = when (bucket) {
  ...
  class Dialog : WrapperDialogFragment() {
    override fun getWrappedFragment(): Fragment = SafetyNumberReviewConnectionsFragment()
  }
