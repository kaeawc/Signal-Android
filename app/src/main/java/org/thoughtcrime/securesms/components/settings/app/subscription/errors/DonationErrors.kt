...
@StringRes
fun StripeFailureCode.mapToErrorStringResource(inAppPaymentType: InAppPaymentType): Int = when (this) {
...
@StringRes
fun StripeDeclineCode.mapToErrorStringResource(): Int = when (this) {
