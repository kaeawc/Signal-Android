...
class WhoCanFindMeByPhoneNumberRepository {
  ...
  fun getCurrentState(): WhoCanFindMeByPhoneNumberState = when (SignalStore.phoneNumberPrivacy.phoneNumberDiscoverabilityMode) {
  ...
  fun onSave(whoCanFindMeByPhoneNumberState: WhoCanFindMeByPhoneNumberState): Completable = Completable.fromAction {
