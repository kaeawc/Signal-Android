 ...
 */
fun <T> SavedStateHandle.delegate(key: String): ReadWriteProperty<Any?, T?> = NullableSavedStateHandleDelegate(this, key)
 ...
 */
fun <T> SavedStateHandle.delegate(key: String, default: () -> T): ReadWriteProperty<Any?, T> = DefaultSavedStateHandleDelegate(this, key, default)
...
private class NullableSavedStateHandleDelegate<T>(
  ...
  override operator fun getValue(thisRef: Any?, property: KProperty<*>): T? = handle[key]
...
private class DefaultSavedStateHandleDelegate<T>(
  ...
  override operator fun getValue(thisRef: Any?, property: KProperty<*>): T = handle[key] ?: lazyDefault
