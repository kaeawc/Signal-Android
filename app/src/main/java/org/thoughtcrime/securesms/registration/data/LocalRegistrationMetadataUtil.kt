...
object LocalRegistrationMetadataUtil {
  fun createLocalRegistrationMetadata(localAciIdentityKeyPair: IdentityKeyPair, localPniIdentityKeyPair: IdentityKeyPair, registrationData: RegistrationData, remoteResult: RegistrationRepository.AccountRegistrationResult, reglockEnabled: Boolean): LocalRegistrationMetadata = LocalRegistrationMetadata.Builder().apply {
  ...
  fun LocalRegistrationMetadata.getAciIdentityKeyPair(): IdentityKeyPair = IdentityKeyPair(aciIdentityKeyPair.toByteArray())

  fun LocalRegistrationMetadata.getPniIdentityKeyPair(): IdentityKeyPair = IdentityKeyPair(pniIdentityKeyPair.toByteArray())

  fun LocalRegistrationMetadata.getAciPreKeyCollection(): PreKeyCollection = PreKeyCollection(
  ...
  fun LocalRegistrationMetadata.getPniPreKeyCollection(): PreKeyCollection = PreKeyCollection(
